...
RUN (mkdir -p /build/flux-markdown-to-html-converter-rest-api/libs/flux-autoload-api && cd /build/flux-markdown-to-html-converter-rest-api/libs/flux-autoload-api && wget -O - https://github.com/flux-eco/flux-autoload-api/releases/download/v2022-07-12-1/flux-autoload-api-v2022-07-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxAutoloadApi FluxMarkdownToHtmlConverterRestApi\\Libs\\FluxAutoloadApi)

RUN (mkdir -p /build/flux-markdown-to-html-converter-rest-api/libs/flux-markdown-to-html-converter-api && cd /build/flux-markdown-to-html-converter-rest-api/libs/flux-markdown-to-html-converter-api && wget -O - https://github.com/flux-eco/flux-markdown-to-html-converter-api/releases/download/v2022-07-12-1/flux-markdown-to-html-converter-api-v2022-07-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxMarkdownToHtmlConverterApi FluxMarkdownToHtmlConverterRestApi\\Libs\\FluxMarkdownToHtmlConverterApi)
